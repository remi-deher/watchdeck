...
.ui-data-table__check {
  ...
  border: 1.5px solid color-mix(in srgb, var(--text) 55%, transparent); border-radius: var(--radius-xs);
  background: var(--surface-2); color: #0b0b0e; cursor: pointer;
}
...
.ui-data-table__check :deep(svg) { color: #0b0b0e; stroke-width: 3.5; }
