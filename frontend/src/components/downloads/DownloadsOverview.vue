...
.downloads-overview{display:grid}.health-kpi-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:var(--space-3);margin-bottom:var(--space-4)}.health-kpi-card{display:flex;flex-direction:column;gap:2px;padding:14px;border:1px solid var(--border);border-radius:var(--radius-md);background:var(--surface)}.health-kpi-card.alert{border-color:color-mix(in srgb,var(--danger) 50%,var(--border));background:color-mix(in srgb,var(--danger) 6%,var(--surface))}.kpi-label{font-size:var(--fs-xs);color:var(--muted);font-weight:600}.kpi-value{font-size:var(--fs-xl);font-weight:800;color:var(--text)}.health-kpi-card.alert .kpi-value{color: var(--red-text)}.health-kpi-card small{font-size: var(--fs-xs);color:var(--muted)}.attention-section{border-color:color-mix(in srgb,var(--danger) 40%,var(--border));background:color-mix(in srgb,var(--danger) 4%,var(--surface));margin-bottom:var(--space-4)}.attention-item{justify-content:space-between;border:1px solid var(--border);background:var(--surface)}.overview-disk-space{margin-top:var(--space-4)}.overview-activity-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:var(--space-4);margin-top:var(--space-4)}.overview-panel{display:flex;flex-direction:column;gap:var(--space-3);padding:16px}.mini-imports-list,.mini-torrents-list{display:flex;flex-direction:column;gap:10px}.mini-import-item{display:flex;align-items:center;gap:12px;padding:8px;border-radius:var(--radius-sm);background:var(--surface-2)}.mini-poster-wrap{width:32px;height:48px;border-radius:var(--radius-sm);overflow:hidden;background:var(--surface);display:flex;align-items:center;justify-content:center;flex-shrink:0}.mini-poster-img{width:100%;height:100%;object-fit:cover}.mini-poster-fallback svg{width:16px;height:16px;color:var(--muted)}.mini-import-info,.mini-torrent-info{display:flex;flex-direction:column;min-width:0;flex:1}.mini-import-info strong,.mini-torrent-info strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:var(--fs-xs)}.mini-import-info small,.mini-torrent-info small{color:var(--muted);font-size: var(--fs-xs)}.mini-torrent-item{display:flex;align-items:center;justify-content:space-between;gap:12px;padding:10px 12px;border-radius:var(--radius-sm);background:var(--surface-2)}
