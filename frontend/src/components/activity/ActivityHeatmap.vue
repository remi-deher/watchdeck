...
.panel-head>strong{color:var(--text);font-size:var(--fs-xs)}.heatmap-scroll{margin-top:14px;overflow-x:auto}.heatmap-grid{display:grid;grid-template-columns:38px repeat(24,minmax(22px,1fr));gap: var(--space-1);min-width:760px}.heatmap-grid small{color:var(--muted);font-size:var(--fs-xs);text-align:center}.heatmap-grid>strong{align-self:center;color:var(--muted);font-size:var(--fs-xs)}.heatmap-grid i{aspect-ratio:1;border-radius:var(--radius-xs);background:var(--accent)}.heatmap-mobile{display:none}.heatmap-panel footer{display:flex;align-items:center;justify-content:flex-end;gap: var(--space-1);margin-top:9px;color:var(--muted);font-size:var(--fs-xs)}.heatmap-panel footer i{width:10px;height:10px;border-radius:var(--radius-xs);background:var(--accent)}@include bp.until(phablet) {.heatmap-scroll,.heatmap-panel footer{display:none}.heatmap-mobile{display:grid;gap: var(--space-3);margin-top:14px}.heatmap-mobile article{display:grid;grid-template-columns:1fr auto;gap: var(--space-1)}.heatmap-mobile strong,.heatmap-mobile span{font-size:var(--fs-sm)}.heatmap-mobile span{color:var(--muted);font-variant-numeric:tabular-nums}.heatmap-mobile i{grid-column:1/-1;height:12px;border-radius:var(--radius-pill);background:linear-gradient(90deg,var(--accent),var(--amber-text))}}
</style>
