...
.session-kpis article{grid-template-columns:20px minmax(0,1fr);gap:3px 9px}.session-kpis article>svg{grid-row:1/4;width:18px;height:18px;color:var(--accent)}.session-kpis article>*:not(svg){grid-column:2}.session-kpis .network-kpi.remote>svg{color:#fb923c}.session-kpis .network-kpi.local>svg{color: var(--green-text)}.session-kpis .buffer-kpi.low>svg,.session-kpis .buffer-kpi.low strong{color: var(--amber-text)}
