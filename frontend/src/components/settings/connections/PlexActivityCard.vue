...
.card-actions{display:flex;flex-wrap:wrap;gap:var(--space-2);align-items:center;margin-top:4px}.connection-result{margin:0;color:var(--muted);font-size:var(--fs-sm);line-height:1.5}.collection-toggle{display:grid!important;grid-template-columns:auto minmax(0,1fr) auto;align-items:center;gap:var(--space-3);padding:15px;border:1px solid color-mix(in srgb, var(--red) 35%, transparent);border-radius:var(--radius-md);background:color-mix(in srgb, var(--red) 6%, transparent);cursor:pointer}.collection-toggle.active{border-color:color-mix(in srgb, var(--green) 35%, transparent);background:color-mix(in srgb, var(--green) 7%, transparent)}.collection-toggle-copy{display:grid;gap:var(--space-1)}.collection-toggle-copy strong{font-size:var(--fs-md)}.collection-toggle-copy small{color:color-mix(in srgb,var(--text) 72%,transparent);font-size:var(--fs-sm);line-height:1.45}.collection-state{padding:5px 9px;border-radius:var(--radius-pill);background:color-mix(in srgb, var(--red) 13%, transparent);color:var(--red-text);font-size:var(--fs-xs);font-weight:750}.collection-toggle.active .collection-state{background:color-mix(in srgb, var(--green) 13%, transparent);color: var(--green-text)}@include bp.until(phablet) {.card-actions>*{width:100%;min-height:44px}.collection-toggle{grid-template-columns:auto minmax(0,1fr)}.collection-state{grid-column:2;justify-self:start}}
</style>
