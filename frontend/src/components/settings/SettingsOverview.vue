...
.settings-overview{display:grid;gap: var(--space-4)}.settings-health-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap: var(--space-4)}.settings-health-card{display:grid;grid-template-columns:44px minmax(0,1fr) auto;gap:var(--space-2) var(--space-3);align-items:center;min-height:132px;padding:18px;border:1px solid var(--border);border-radius:var(--radius-lg);background:var(--surface);color:var(--text);text-align:left;transition:border-color var(--motion-duration-fast), transform var(--motion-duration-fast), box-shadow var(--motion-duration-fast)}.settings-health-card:hover{border-color:var(--accent);transform:translateY(-2px);box-shadow:0 12px 26px rgb(var(--shadow-color) / calc(.2 * var(--shadow-scale)))}.settings-health-card>svg{width:22px;height:22px;padding:10px;box-sizing:content-box;border:1px solid var(--border);border-radius:var(--radius-md);background:var(--surface-2);color:var(--muted)}.settings-health-card>div{display:grid;gap: var(--space-1);min-width:0}.settings-health-card div span{color:var(--muted);font-size:var(--fs-xs);font-weight:700;}.settings-health-card strong{font-size:var(--fs-md);line-height:1.3}.settings-health-card small{overflow:hidden;color:color-mix(in srgb,var(--text) 68%,transparent);font-size:var(--fs-sm);line-height:1.4;text-overflow:ellipsis;white-space:nowrap}.health-state{grid-column:2/-1;justify-self:start;padding:5px 9px;border-radius:var(--radius-pill);font-size:var(--fs-xs);font-weight:700;background:var(--surface-2);color:var(--muted)}.health-state.active{color: var(--green-text);background:color-mix(in srgb, var(--green) 10%, transparent)}.health-state.incomplete{color:var(--accent);background:color-mix(in srgb, var(--accent) 10%, transparent)}.configuration-progress{padding:20px}.configuration-progress progress{width:100%;height:10px}.configuration-progress p{margin-bottom:0;color:var(--muted);font-size:var(--fs-sm);line-height:1.5}@include bp.until(desktop) {.settings-health-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@include bp.until(tablet) {.settings-health-grid{grid-template-columns:1fr;gap: var(--space-3)}.settings-health-card{grid-template-columns:42px minmax(0,1fr) auto;min-height:112px;padding:15px}.settings-health-card>svg{width:20px;height:20px}.settings-health-card strong{font-size:var(--fs-md)}.settings-health-card small{white-space:normal}.configuration-progress{padding:16px}.configuration-progress :deep(.ui-section-header){align-items:flex-start}.configuration-progress :deep(.ui-section-meta strong){font-size:var(--fs-lg)}}
</style>
